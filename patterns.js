...
function showHidLayers(layer){
    ...
    .on("click",function(){
        if(layersControl[layer]==false){
            if(layer == "trees"){
                d3.selectAll("."+layer).transition().duration(1000).delay(function(d,i){return i/6}).style("opacity",.7)
            }else{
            ...
            if(layer=="trees"){
                d3.selectAll("."+layer).transition().duration(1000).delay(function(d,i){return i/6}).style("opacity",0)
            }else{
